    ...
    const pages = [
        ...
        <StoryPage key="cover" backgroundColor="bg-gradient-to-br from-rose-200 to-purple-200">
            <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                >
                    <Image
                        src="/images/IMG_20250504_162130.jpg"
                        alt="Heart icon"
                        priority={true}
                        width={176}
                        height={176}
                ...
                <div className="text-2xl md:text-3xl text-purple-700 mb-8 relative z-10">
                    Happy Birthdaaay, <br />my<FlipWords words={['sunshine', 'soulmate', 'everything', 'love', 'world']} className="text-nowrap" />
                </div>
                <motion.button
        ...
        <StoryPage key="journey" backgroundColor="bg-gradient-to-br from-blue-200 to-green-200">
            ...
            <div className="space-y-4 flex-1 overflow-y-auto overflow-x-hidden rounded-xl custom-scrollbar">
                {[
                    { date: '21 March, 2023', event: 'Our Journey Began', emoji: '❤️' },
                    { date: '31 March, 2023', event: 'First Meet Together', emoji: '🫂' },
                    { date: '31 March, 2023', event: 'First Hug', emoji: '🤗' },
                    { date: '22 April , 2024', event: 'First Kiss', emoji: '😘' },
                    { date: '8 September, 2024', event: 'First Movie', emoji: '🎬' },
                ]
                    .map((item, index) => (
                        <motion.div
                            key={index}
